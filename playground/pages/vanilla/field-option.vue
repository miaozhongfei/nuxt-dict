<template>
  <div>
    ...
    <p style="color: #666">
      通过 opts.field 指定取字典项的哪个字段，默认取 label。支持 translate / translatePath。
    </p>
      ...
      <table border="1" cellpadding="6" cellspacing="0" style="border-collapse: collapse">
        ...
        <tbody>
          <tr v-for="item in store2StatusData" :key="item.value">
            ...
            <td>{{ item.label }}</td>
            <td>
              {{ $dict.translate('status', item.value, { storeName: 'dicts2', field: 'color' }) }}
            </td>
            <td>
              {{ $dict.translate('status', item.value, { storeName: 'dicts2', field: 'color' }) }}
            </td>
      ...
      <table border="1" cellpadding="6" cellspacing="0" style="border-collapse: collapse">
        ...
        <tbody>
          <tr>
            ...
            <td>
              {{
                $dict.translatePath('region', '330108', { storeName: 'dicts2', separator: ' → ' })
              }}
            </td>
          </tr>
          <tr>
            ...
            <td>
              {{
                $dict.translatePath('region', '440104', { storeName: 'dicts2', separator: ' → ' })
              }}
            </td>
          </tr>
        </tbody>
